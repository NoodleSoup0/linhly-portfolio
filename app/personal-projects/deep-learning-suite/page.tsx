...
export default function ProjectPage() {
  const stack = ["PyTorch", "Python", "NumPy", "Matplotlib", "Deep Learning"]
  return (
    <main className="max-w-3xl mx-auto px-6 py-10 space-y-8">
      <div className="space-y-2">
        <SectionTitle>Deep Learning Model Suite</SectionTitle>
        <p className="text-slate-300 leading-relaxed">A set of deep learning architectures implemented and evaluated in PyTorch with clean preprocessing and evaluation pipelines.</p>
      </div>
